...
if($action == 'sum') {
  ...
  if($status === true) {
    ...
    $output = "The payment transaction was successful. 10 kr was withdrawn from you account and I added 23% intrest on the money you have still to pay. This is our excellent mortage for short lones for people in need.";
    $outputClass = 'success';
  }
